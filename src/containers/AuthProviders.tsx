        ...
        <>
            ...
            <div className="w-full text-center">
                <div className="w-full flex items-center justify-between">
                    <div className="w-5/12 h-[.08rem] bg-secondary_text dark:bg-dark_secondary_text bg-opacity-50"></div>
                    <p className="text-secondary_text dark:text-dark_secondary_text">O</p>
                    <div className="w-5/12 h-[.08rem] bg-secondary_text dark:bg-dark_secondary_text bg-opacity-50"></div>
                </div>
